...
class Chat2SemanticReviewR65Tests(unittest.TestCase):
    def test_r65_resolves_deterministically(self):
        candidates = _load("mappings/candidates/v308.semantic.chat2.r65.json")
        expected = _load("mappings/candidates/v308.semantic-review.chat2.r65.json")
        ...
        self.assertEqual(
            actual["review_id"],
            "SEMREVIEW_FB70227883B059A9D489",
        )
        self.assertEqual(actual, expected)

    def test_r65_expected_stable_ids(self):
        review = _load("mappings/candidates/v308.semantic-review.chat2.r65.json")
        self.assertEqual(
            {row["proposed_name"]: row["stable_id"] for row in review["proposals"]},
            {
                "CacheUpdater": "CLIENT_CLASS_000087",
                "ClientUpdater": "CLIENT_CLASS_000088",
                "ConfigUpdater": "CLIENT_CLASS_000089",
                "SpriteUpdater": "CLIENT_CLASS_000090",
                "AssetUpdateError": "CLIENT_CLASS_000091",
                "AssetUpdateCoordinator": "CLIENT_CLASS_000092",
                "AssetUpdater": "CLIENT_CLASS_000093",
                "AssetVersion": "CLIENT_CLASS_000094",
            },
        )

    def test_r65_names_and_owners_do_not_overlap_prior_reviews(self):
        current = _load("mappings/candidates/v308.semantic-review.chat2.r65.json")
