...
def _class_lineage():
    return {
        ...
        "classes": [
            {
                "logical_id": "CLIENT_CLASS_000067",
                "semantic_name": None,
                ...
                "lineage": [
                    {
                        "build_id": "v308",
                        "internal_name": "rs/a/d",
                        "entry_path": "rs/a/d.class",
                        "entry_sha256": "b" * 64,
...
class Chat2SemanticReviewR34Tests(unittest.TestCase):
    def test_r34_resolves_deterministically(self):
        candidates = _load(
            "mappings/candidates/v308.semantic.chat2.r34.json"
        )
        expected = _load(
            "mappings/candidates/v308.semantic-review.chat2.r34.json"
        )
    ...
    def test_r34_expected_stable_id(self):
        review = _load(
            "mappings/candidates/v308.semantic-review.chat2.r34.json"
        )
        self.assertEqual(
            ...
            {"FaceNormalBuffer": "CLIENT_CLASS_000067"},
        )

    def test_r34_name_and_owner_do_not_overlap_prior_reviews(self):
        r34 = _load(
            "mappings/candidates/v308.semantic-review.chat2.r34.json"
        )
        names = {row["proposed_name"] for row in r34["proposals"]}
        owners = {
            row["source_coordinate"]["owner"]
            for row in r34["proposals"]
        }
