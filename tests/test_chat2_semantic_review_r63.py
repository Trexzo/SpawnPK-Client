...
class Chat2SemanticReviewR63Tests(unittest.TestCase):
    def test_r63_resolves_deterministically(self):
        candidates = _load("mappings/candidates/v308.semantic.chat2.r63.json")
        expected = _load("mappings/candidates/v308.semantic-review.chat2.r63.json")
