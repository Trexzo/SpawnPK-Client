...
class Chat2SemanticReviewR32Tests(unittest.TestCase):
    def test_r32_resolves_deterministically(self):
        candidates = _load(
            "mappings/candidates/"
            "v308.semantic.chat2.r32.json"
        )
        expected = _load(
            "mappings/candidates/"
            "v308.semantic-review.chat2.r32.json"
        )
    ...
    def test_r32_name_and_owner_do_not_overlap_prior_reviews(self):
        ...
        self.assertTrue(r32_names.isdisjoint(prior_names))
        self.assertTrue(r32_owners.isdisjoint(prior_owners))
