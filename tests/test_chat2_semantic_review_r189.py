    ...
    for logical_id, internal_name in CLASS_COORDS:
        classes.append({
            ...
            "lineage": [{
                ...
                "relation": "BASELINE",
                "confidence": 1.0,
                "provenance": [{"authority": "EXACT_CURRENT_CLIENT", "source": "chat2-r189-fixture"}],
            }],
            "semantic_provenance": [],
        })
    return {
        ...
        "builds": [{
            "build_id": "v308", "build_number": 308, "sha256": SHA,
            "source_name": "client(6).jar", "authority": "EXACT_CURRENT_CLIENT",
        }],
        "classes": classes,
        "unresolved": [],
    }
...
def _member_lineage():
    return {
        ...
        "class_namespace": "spawnpk-client", "baseline_build_id": "v308",
        "source_sha256": SHA, "members": [], "unresolved": [],
    }
...
class Chat2SemanticReviewR189Tests(unittest.TestCase):
    def test_r189_resolves_deterministically(self):
        candidates = _load("mappings/candidates/v308.semantic.chat2.r189.json")
        expected = _load("mappings/candidates/v308.semantic-review.chat2.r189.json")
