...
CLASS_COORDS = [
    ("CLIENT_CLASS_000107", "rs/cache/osrs/util/a"),
    ("CLIENT_CLASS_000108", "rs/cache/osrs/util/b"),
]
...
class Chat2SemanticReviewR100Tests(unittest.TestCase):
    def test_r100_resolves_deterministically(self):
        candidates = _load("mappings/candidates/v308.semantic.chat2.r100.json")
        expected = _load("mappings/candidates/v308.semantic-review.chat2.r100.json")
        ...
        self.assertEqual(actual["review_id"], "SEMREVIEW_F3C13FDAE984E6075BB8")
        self.assertEqual(actual, expected)

    def test_r100_expected_stable_ids(self):
        review = _load("mappings/candidates/v308.semantic-review.chat2.r100.json")
        self.assertEqual(
            {row["proposed_name"]: row["stable_id"] for row in review["proposals"]},
            {
                "OsrsSequenceOverrideLoader": "CLIENT_CLASS_000107",
                "OsrsObjectOverrideLoader": "CLIENT_CLASS_000108",
            },
        )

    def test_r100_name_and_owner_do_not_overlap_prior_reviews(self):
        current = _load("mappings/candidates/v308.semantic-review.chat2.r100.json")
