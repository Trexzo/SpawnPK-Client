...
class Chat2SemanticReviewR152Tests(unittest.TestCase):
    def test_r152_resolves_deterministically(self):
        candidates = _load("mappings/candidates/v308.semantic.chat2.r152.json")
        expected = _load("mappings/candidates/v308.semantic-review.chat2.r152.json")
        ...
        self.assertEqual(actual["review_id"], "SEMREVIEW_4D081ABE7A8E9C4DCC3C")
        self.assertEqual(actual, expected)

    def test_r152_expected_stable_id(self):
        review = _load("mappings/candidates/v308.semantic-review.chat2.r152.json")
        self.assertEqual(
            {row["proposed_name"]: row["stable_id"] for row in review["proposals"]},
            {
                "PixelBlender": "CLIENT_CLASS_000351",
            },
        )

    def test_r152_name_and_owner_do_not_overlap_prior_reviews(self):
        current = _load("mappings/candidates/v308.semantic-review.chat2.r152.json")
