...
CLASS_COORDS = [
    ("CLIENT_CLASS_001019", "rs/ui/a/c"),
    ("CLIENT_CLASS_001021", "rs/ui/a/e"),
    ("CLIENT_CLASS_001023", "rs/ui/a/g"),
    ("CLIENT_CLASS_001024", "rs/ui/a/h"),
]
    ...
    for logical_id, internal_name in CLASS_COORDS:
        classes.append({
            ...
            "lineage": [{
                ...
                "relation": "BASELINE",
                "confidence": 1.0,
                "provenance": [{"authority":"EXACT_CURRENT_CLIENT","source":"chat2-r162-fixture"}],
            }],
            "semantic_provenance": [],
        })
    return {
...
class Chat2SemanticReviewR162Tests(unittest.TestCase):
    def test_r162_resolves_deterministically(self):
        actual = resolve_semantic_candidates(_class_lineage(), _member_lineage(), _load("mappings/candidates/v308.semantic.chat2.r162.json"))
        expected = _load("mappings/candidates/v308.semantic-review.chat2.r162.json")
        self.assertEqual(actual["proposal_count"], 4)
        self.assertEqual(actual["unresolved"], [])
        self.assertEqual(actual["review_id"], "SEMREVIEW_495BB30E145BAAA19582")
        self.assertEqual(actual, expected)

    def test_r162_expected_stable_ids(self):
        review = _load("mappings/candidates/v308.semantic-review.chat2.r162.json")
        self.assertEqual({row["proposed_name"]:row["stable_id"] for row in review["proposals"]},{
            "InfoBox":"CLIENT_CLASS_001019",
            "InfoBoxSpriteType":"CLIENT_CLASS_001021",
            "InfoBoxOverlay":"CLIENT_CLASS_001023",
            "InfoBoxPriority":"CLIENT_CLASS_001024",
        })

    def test_r162_name_and_owner_do_not_overlap_prior_reviews(self):
        current = _load("mappings/candidates/v308.semantic-review.chat2.r162.json")
