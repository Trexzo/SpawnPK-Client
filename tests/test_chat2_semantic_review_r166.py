...
CLASS_COORDS = [
    ("CLIENT_CLASS_001093", "rs/ui/components/y"),
]
...
class Chat2SemanticReviewR166Tests(unittest.TestCase):
    def test_r166_resolves_deterministically(self):
        candidates = _load("mappings/candidates/v308.semantic.chat2.r166.json")
        ...
        self.assertEqual(actual["review_id"], "SEMREVIEW_DD66FE413150F4F4C6A4")
    ...
    def test_r166_expected_stable_id(self):
        ...
        self.assertEqual(
            ...
            {"ProgressBar": "CLIENT_CLASS_001093"},
        )
