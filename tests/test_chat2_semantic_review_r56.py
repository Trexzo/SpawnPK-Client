...
class Chat2SemanticReviewR56Tests(unittest.TestCase):
    def test_r56_resolves_deterministically(self):
        candidates = _load("mappings/candidates/v308.semantic.chat2.r56.json")
        expected = _load("mappings/candidates/v308.semantic-review.chat2.r56.json")
