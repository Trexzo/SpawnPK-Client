...
class Chat2SemanticReviewR18Tests(unittest.TestCase):
    def test_r18_resolves_deterministically(self):
        candidates = _load(
            "mappings/candidates/"
            "v308.semantic.chat2.r18.json"
        )
        expected = _load(
            "mappings/candidates/"
            "v308.semantic-review.chat2.r18.json"
        )
    ...
    def test_r18_expected_stable_ids(self):
        review = _load(
            "mappings/candidates/"
            "v308.semantic-review.chat2.r18.json"
        )
        ...
        self.assertEqual(
            by_name,
            {
                "Schedule": "CLIENT_CLASS_001122",
                "ScheduledMethod": "CLIENT_CLASS_001123",
                "Scheduler": "CLIENT_CLASS_001124",
            },
        )

    def test_r18_names_do_not_overlap_prior_reviews(self):
        r18 = _load(
            "mappings/candidates/"
            "v308.semantic-review.chat2.r18.json"
        )
        ...
        self.assertTrue(r18_names.isdisjoint(prior_names))
