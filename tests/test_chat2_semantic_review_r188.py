...
CLASS_COORDS = [("CLIENT_CLASS_000909", "rs/s/f/c")]
        ...
        classes.append(
            {
                ...
                "lineage": [{
                    ...
                    "relation": "BASELINE",
                    "confidence": 1.0,
                    "provenance": [{"authority": "EXACT_CURRENT_CLIENT", "source": "chat2-r188-fixture"}],
                }],
                "semantic_provenance": [],
            }
        )
...
class Chat2SemanticReviewR188Tests(unittest.TestCase):
    def test_r188_resolves_deterministically(self):
        candidates = _load("mappings/candidates/v308.semantic.chat2.r188.json")
        expected = _load("mappings/candidates/v308.semantic-review.chat2.r188.json")
