...
provenance. It does **not** change canonical semantic state. Any such member still enters
the ordinary member-safety report and requires the same exact report-bound acceptance
before bytecode rewriting.
