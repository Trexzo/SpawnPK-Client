...
Recomputing the immutable v308 baseline ordering directly from the exact client gives:
...
proposals    16
unresolved   0
review_id    SEMREVIEW_2271674067C2B1C69D77
```
...
`resolve_semantic_candidates()` and requires byte-for-byte equality with the committed
review output.
